...
echo "<title>DNOCS - Auditoria de Software e Hardware</title>" >> $REPORTFILE
...
echo "</head>" >> $REPORTFILE
echo "<body>" >> $REPORTFILE
echo "<h1>Auditoria no Hardware e no Software - DNOCS</h1><br />" >> $REPORTFILE
echo "<div id=\"content\">" >> $REPORTFILE
echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
echo "<tr><td colspan=\"2\"><b>Informações do Sistema</b></td></tr>" >> $REPORTFILE
...
# System Hardware
echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
echo "<tr><td colspan=\"2\"><b>Informações sobre o Hardware</b></td></tr>" >> $REPORTFILE
echo "<tr bgcolor=\"#F1F1F1\"><td>Processadores: </td><td>$CPU_NUMBER</td></tr>" >> $REPORTFILE
echo "<tr><td width=\"250\">Velocidade: </td><td>$CPU_SPEED Mhz</td></tr>" >> $REPORTFILE
echo "<tr bgcolor=\"#F1F1F1\"><td>Nome: </td><td>$CPU_NAME</td></tr>" >> $REPORTFILE
echo "<tr><td>Fabricante: </td><td>$CPU_MANUFACTURER</td></tr>" >> $REPORTFILE
echo "<tr bgcolor=\"#F1F1F1\"><td>Processor SpeedStep Capable: </td><td>$CPU_SPEEDSTEP</td></tr>" >> $REPORTFILE
echo "<tr><td>Memória RAM</td><td>$RAM_SIZE_KB Mb<td></tr>" >> $REPORTFILE
echo "<tr bgcolor=\"#F1F1F1\"><td>Data da BIOS: </td><td>$PC_BIOS_DATE</tr>" >> $REPORTFILE
echo "<tr><td>Versão da BIOS: </td><td>$PC_BIOS_VERSION</td></tr>" >> $REPORTFILE
# Graphic Card
PCILIST=`lspci -vm`
...
for i in $PERIF; do
  ...
  then
    echo "<tr bgcolor=\"#F1F1F1\"><td>Fabricante da Placa de Vídeo</td><td>$PCI_MANUFACTURER</td></tr>" >> $REPORTFILE
    echo "<tr><td>Nome da placa de vídeo: </td><td>$PCI_NAME</td></tr>" >> $REPORTFILE
  fi
done
...
echo "<tr bgcolor=\"#F1F1F1\"><td>Fabricante da placa de Som</td><td>$SOUND_VENDOR</td></tr>" >> $REPORTFILE
echo "<tr><td>Nome da placa de Som: </td><td>$SOUND_CARD</td></tr>" >> $REPORTFILE


#Network
echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
echo "<tr><td colspan=\"2\"><b>Informações sobre a Rede</b></td></tr>" >> $REPORTFILE
NET_DNS=`cat /etc/resolv.conf | grep "nameserver" | cut -d" " -f2`
echo "<tr bgcolor=\"#F1F1F1\"><td width=\"250\">Nome da Rede: </td><td>$HOSTNAME</td></tr>" >> $REPORTFILE
echo "<tr><td>Servidor de DNS: </td><td>$NET_DNS</td></tr>" >> $REPORTFILE
#Network detection
echo "<tr><td colspan=\"2\"><br /><b>Placas de Rede</b></td></tr>" >> $REPORTFILE
...
do
  ...
  echo "<tr bgcolor=\"#F1F1F1\"><td>Placa: </td><td><b>$NET_NAME</b> - $NET_DESCRIPTION</td></tr>" >> $REPORTFILE
  echo "<tr><td>Description: </td><td>$NET_DEVICE</td></tr>" >> $REPORTFILE
  echo "<tr bgcolor=\"#F1F1F1\"><td>Fabricante da Placa de Rede</td><td>$NET_MANUFACTURER</td></tr>" >> $REPORTFILE
  echo "<tr><td>MAC: </td><td>$NET_MAC</td></tr>" >> $REPORTFILE
  if [ "$NET_IP" != "" ]
  then
    echo "<tr bgcolor=\"#F1F1F1\"><td>IP: </td><td>$NET_IP</td></tr>" >> $REPORTFILE
...
# Hard Disks
echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
echo "<tr><td colspan=\"2\"><b>HDs</b></td></tr>" >> $REPORTFILE
...
do
  ...
  echo "<tr bgcolor=\"#F1F1F1\"><td width=\"250\">Fabricante: </td><td>$DISK_VENDOR</td></tr>" >> $REPORTFILE
  echo "<tr><td>Modelo: </td><td>$DISK_MODEL</td></tr>" >> $REPORTFILE
  echo "<tr bgcolor=\"#F1F1F1\"><td>Serial: </td><td>$DISK_SERIAL</td></tr>" >> $REPORTFILE
  echo "<tr><td>Tamanho: </td><td>$DISK_SIZE Gb</td></tr>" >> $REPORTFILE
  echo "<tr bgcolor=\"#F1F1F1\"><td>Caminho: </td><td>$DISK_PATH</td></tr>" >> $REPORTFILE
  echo "<tr><td><br /> </td><td></td></tr>" >> $REPORTFILE
done
echo "</table>" >> $REPORTFILE
...
# Optical Drives
echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
echo "<tr><td colspan=\"2\"><b>Drive de CD ROM</b></td></tr>" >> $REPORTFILE
...
do
  ...
  echo "<tr bgcolor=\"#F1F1F1\"><td width=\"250\">Fabricante: </td><td>$CD_VENDOR</td></tr>" >> $REPORTFILE
  ...
  echo "<tr bgcolor=\"#F1F1F1\"><td>Ponto de Montagem: </td><td>$CD_MOUNT</td></tr>" >> $REPORTFILE
  echo "<tr><td><br /> </td><td></td></tr>" >> $REPORTFILE
done
echo "</table>" >> $REPORTFILE
...
#Volumes
echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
echo "<tr><td colspan=\"2\"><b>Discos</b></td></tr>" >> $REPORTFILE
...
then
  echo "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" class=\"content\">" >> $REPORTFILE
  echo "<tr><td colspan=\"2\"><b>Programas Instalados</b></td></tr>" >> $REPORTFILE
  echo "<tr><td width=\"250\"><i>Nome do Pacote</i></td><td><i>Versão</i></td></tr>" >> $REPORTFILE
  TR_BACK="#FFFFFF"
